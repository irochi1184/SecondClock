...
無料版では、すべての書体と太さ、文字色、単色・グラデーションの自由な配色、オーロラ・オーシャンテーマを利用できます。これらの設定はウィジェットにも反映されます。

SecondClock Proでは、5種類のグラデーション、写真背景と暗さ調整、夕焼け・桜・夜空の限定テーマを買い切りで解放します。写真背景はホーム画面ウィジェットにも反映されます。
