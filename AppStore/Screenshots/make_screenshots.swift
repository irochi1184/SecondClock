...
private func makeIAPReview(output: URL) {
    makePNG(at: output) {
        ...
        drawText("無制限プリセット・写真背景・\n限定デザインを一度の購入で解放します。", x: 1710, top: 430, width: 940, height: 150, size: 36, weight: .medium, color: .white.withAlphaComponent(0.78), lineSpacing: 10)
        drawPill("UNLIMITED", x: 1710, top: 710, width: 330)
        drawPill("写真背景", x: 2070, top: 710, width: 300)
        drawPill("限定デザイン", x: 2400, top: 710, width: 330)
    }
}
